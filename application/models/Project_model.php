...
class Project_model extends CI_Model
{
    ...
    public function get_project_checklists($id){
        $res = $this->db->select('main.project_id,main.list_id,main.checklist_id,list.title as list_title, checklist.title as checklist_title, main.active_bit')
                        ...
                        ->where(['main.project_id'=>$id,'main.delete_bit'=>0])
